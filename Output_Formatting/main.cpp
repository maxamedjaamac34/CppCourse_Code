...
//\n prints a new line
//std:flush sends whatever in the output buffer to the console
#include <iostream>
#include <iomanip>
int main(){
    ...
    //data shows in different lines

    std::cout<<"using std::enl;"<<std::endl;
    std::cout << "Hello" << std::endl;
    std::cout << "World" << std::endl;
    
    std::cout << std::endl;
    std::cout<<"using backslash and n "<<std::endl;

    //also \n works similarly but different
    std::cout << "Hello\n";
    std::cout << "World\n";
     

    std::cout << std::endl;
    std::cout <<"using std::flush"<< std::endl;
    ...
    std::cout << std::endl;
    std::cout << "using std::setw()" <<std::endl;
    std::cout << std::endl;
    ...
    std::cout << std::endl;
    std::cout << "Table with fill characters using setfill() :  " << std::endl;
