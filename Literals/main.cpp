...
//It lives in your program executable
//it is stored in your program binary code while a variable is allocated a space somewhere
//a data can be copied from literals into memory locations???
...
int main(){
   ...
   //unsigned int game_score {(-20}; //Error
    ...
    std::cout << std::hex <<  "The hex number should be 555 : " << hex_number << std::endl;
    std::cout << std::dec <<  "The hex number2 is : " << hex_number2 << std::endl;
    
    //Representing colors with hex
    int black_color {0xffffff};
    std::cout << std::dec<<"Black color is : " << std::dec << black_color << std::endl;

     std::cout<<"Octodecimal numbers"<<std::endl;
