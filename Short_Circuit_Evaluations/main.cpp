...
//one way to save the operations we are doing in logical expression
//for example if you AND a false with anything (false or true), result is gonna be false. 
//so you can put false first
//same thing with OR ing anything with True. result is always true. 
//can safe you from some possibly expensive computations
